window.onload = function() {
	...
	if (ctx) {
		...
		//create variables x,y, radius and offset
		...
		//Draw a blue circle in the clipping mask
		...
		//Draw a yellow circle in the clipping mask
		...
		//Draw a red circle in the clipping mask
